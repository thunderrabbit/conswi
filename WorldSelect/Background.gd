...
var day_texture = preload("res://WorldSelect/Folder_4/universal_background_day@3x.png")
var night_texture = preload("res://WorldSelect/Folder_4/universal_background_night@3x.png")
