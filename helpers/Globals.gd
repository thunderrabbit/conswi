...
const TYPE_SHEEP		= 5
const TYPE_PIG			= 6
const TYPE_CAT			= 90    # CAT is not in items.png or world select screen
const TYPE_LION			= 90    # Right now, LION and following do not exist in items, but are on world select screen
const TYPE_RABBIT		= 90
const TYPE_TIGER		= 90
